...
define('SECRET_SALT','uuiuHtEioJwwyxQforJbvcI00cDE07qH');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','nat@arenadata.io');
...
#define('DBHOST','146.148.9.185'); define('DBUSER','osticketuser'); define('DBPASS','Gok_Syff1Qued');
#define('DBHOST','35.205.192.93'); define('DBUSER','osticketuser'); define('DBPASS','Gok_Syff1Qued');
define('DBHOST','localhost'); define('DBUSER','osticketuser'); define('DBPASS','arenadata');
