...
<form action="tickets.php" method="get" id="ticketSearchForm">
    <div class="col-md-5">
        ...
        <select class="form-control" name="topic_id" class="nowarn form-control" onchange="javascript: this.form.submit(); ">
    ...
    <div class="col-md-2">
    <input class="btn btn-block button" type="submit" value="<?php echo __('Search');?>">
    </div>
