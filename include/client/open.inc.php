...
<?php
    ...
    <!-- Form Buttons -->
      ...
      <p>
          ...
          <input class="button reset" type="reset" name="reset" value="<?php echo __('Reset');?>">
          <input class="button cancel" type="button" name="cancel" value="<?php echo __('Cancel'); ?>" onclick="javascript:
