...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'Arenadata '.__('Support');
...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Lato:300,400,700,900' rel='stylesheet' type='text/css'> <!-- Lato - Google font -->
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/bootstrap.css" media="screen">
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css" media="screen">


    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-3.3.1.min.js?901e5ea"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-ui-1.12.1.custom.min.js?901e5ea"></script>
    ...
    <script type="text/javascript" src="<?php echo ASSETS_PATH; ?>js/custom.js?c18eac4"></script>
    ...
    <div id="container">
        <div id="header">
            <div class="container"> <div class="row">
                ...
                <a class="col-md-4" id="logo" href="<?php echo ROOT_PATH; ?>index.php"
